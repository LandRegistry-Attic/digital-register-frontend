...
WORLDPAY_DICT = {
    ...
    'WP_AUTHORISATION_CALLBACK_URL': 'testpayment.landregisteronline.gov.uk/lrosyt1/servlet/AuthorisationCallbackServlet',
    'WP_CALLBACK_SERVER_URL': os.getenv('WP_CALLBACK_SERVER_URL', 'testpayment.landregisteronline.gov.uk/lrosyt1/servlet/AuthorisationCallbackServlet'),
